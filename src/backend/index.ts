...
export class CosmicClickerRest {

    private static _instance: CosmicClickerRest;
    ...
    public static getInstance(): CosmicClickerRest {
        if(!CosmicClickerRest._instance) {
            CosmicClickerRest._instance = new CosmicClickerRest();
        }
        return CosmicClickerRest._instance;
    }
